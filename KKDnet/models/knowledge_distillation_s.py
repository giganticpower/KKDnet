...
class student(nn.Module):
    ...
    def forward(self,
        ...
        det_out1 = self._upsample(det_out, imgs.size())
        det_loss = self.det_head.loss(det_out1, gt_texts, gt_kernels, training_masks, gt_instances, gt_bboxes)
        ...
        return [f1, f2, f3, f4, f_s, det_out], gt_kernels, outputs
