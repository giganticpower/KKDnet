...
pred_root = '/data/chh/STR/pan_pp.pytorch-master/outputs/submit_ctw'
gt_root = '/data/chh/STR/pan_pp.pytorch-master/data/ctw1500/test/text_label_curve/'
...
def eval_batch(checkpoint_name):
    ...
    with open("/data/chh/STR/pan_pp.pytorch-master/outputs/ctw_eval.txt", 'a+') as f:
