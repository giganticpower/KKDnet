...
pred_root = '/data/chh/STR/pan_pp.pytorch-master/outputs/submit_msra/'
gt_root = '/data/chh/STR/pan_pp.pytorch-master/data/MSRA-TD500/test/'
...
def eval_mrsa(checkpoint):
    ...
    with open("/data/chh/STR/pan_pp.pytorch-master/outputs/mrsa_eval.txt", 'a+') as f:
